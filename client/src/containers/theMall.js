          ...
          <Row gutter={16}>
            <Col className="gutter-row" xs={24} sm={24} md={18} lg={18} xl={18}>
              <Row gutter={16} style={{ marginBottom: "10px"}}>
                ...
                <p style={{ color: '#b2b2b2', marginRight: '15px'}} >b. shop your mall <i className="fas fa-shopping-basket"></i></p>
                </Col>
                <Col className="gutter-row" style={{ textAlign: "Right"}} xs={12} sm={12} md={0} lg={0} xl={0} >
                  ...
                  c. happy checkout <i className="fas fa-shopping-cart"></i></Button>
                </Col>
              </Row>
              <Row gutter={16}>
            ...
            <p style={{ color: '#b2b2b2', marginRight: '15px'}} >c. happy checkout <i className="fas fa-shopping-cart"></i></p>
              <SideCart />
              <SideCartSummary />
            </Col>
          </Row>
