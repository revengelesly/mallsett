    ...
    return (
		<SideCartWrapper  style={{ marginBottom: "10px"}}>
			<Box>
				...
				McDonald - 1280 NW 60th STreet, Miami, FL 33142 <span className="cart-span"><i className="far fa-trash-alt"></i></span>
				</p>
				<div className="delivery-group">
				<p className="delivery-group-header">
				Pick up at 3:30 PM 3/19/28 <i className="fas fa-edit"></i></p>
				<Row className="row delivery-item" gutter={16}>
					<Col className="gutter-row  merchant-group" xs={24} sm={24} md={24} lg={18} xl={18}>
					<p className="item-group-header">2 x 23.98 Shrimp and Co...<i className="fas fa-edit"></i>
					</p>
					</Col>
